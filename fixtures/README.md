...
Usage-rights basis: this image was generated specifically for this project and does not incorporate or derive from a supplied third-party stock asset. There is therefore no separate stock-image licence or attribution requirement; use of the generated output is governed by the OpenAI account terms under which it was created.
