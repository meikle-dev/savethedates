...
| `SUPABASE_URL` | Chosen managed project's HTTPS API URL. Production uses its custom domain, `https://auth.savethedates.co.uk` (F063), so Google sign-in shows `savethedates.co.uk`; staging uses `https://<ref>.supabase.co` |
