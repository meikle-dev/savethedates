...
- **Next:** production setup. The owner runs the browser-agent setup (Supabase, Resend, Render, GoDaddy, Google, Stripe and Sentry), and the engineer applies the migrations to the new production project.
