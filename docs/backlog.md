...
4. **A privacy notice that mentions Google sign-in** (wording requirement in `release-inputs.md` section 3). Drafted at `/privacy` (26 September 2026) and reachable on staging without the password; awaits owner approval.
