...
export function homeMetadata(): Metadata {
  ...
  const description = "Share your save the date, wedding details and collect RSVPs in one beautiful website. Eight themes, one £29 payment. Create and preview your draft for free.";
  const images = [{ url: `${origin}/media/share`, width: 1200, height: 630, alt: "SaveTheDates — Your wedding website, beautifully done. Eight themes. One £29 payment." }];
