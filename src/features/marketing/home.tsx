...
export function MarketingHome({ isAuthenticated = false }: { isAuthenticated?: boolean }) {
  ...
  const primaryAccountLabel = isAuthenticated ? "Return to your workspace" : "Start your site";
      ...
      <main id="main">
        <section className="marketing-hero marketing-width" aria-labelledby="hero-title">
          <div className="hero-copy"><p className="marketing-kicker">A little link. A lovely beginning.</p>
            ...
            <div className="marketing-actions"><Link className="marketing-button" href={accountHref}>{primaryAccountLabel} <span aria-hidden="true">↗</span></Link><a className="marketing-button marketing-outline" href="#themes">Find your style</a></div>
        ...
        <section id="how-it-works" className="marketing-width marketing-how" aria-labelledby="how-title"><div className="section-intro"><p className="marketing-kicker">FROM YES TO YOU’RE INVITED</p><h2 id="how-title">A few details. A lovely hello.</h2></div>
          ...
          <div id="pricing" className="marketing-pricing"><div><p className="marketing-kicker">ONE WEDDING. ONE SIMPLE PRICE.</p><h2>Everything for your day.</h2><p className="price">£29 <span>GBP · one time</span></p><p>No subscription. Draft and preview for free.</p></div><ul><li>All three themes, with a photo of your choice</li><li>Your own wedding URL and Details page</li><li>Up to 100 private RSVP invitations</li><li>A private response list and attendance totals</li><li>Published until 12 months after your wedding date*</li></ul><div className="pricing-action"><Link className="marketing-button" href={accountHref}>{primaryAccountLabel} <span aria-hidden="true">↗</span></Link><p>Make something worth sharing.</p></div><p className="pricing-footnote">*Based on the wedding date at checkout. Your expiry date is fixed when you start checkout.</p></div>
        </section>
