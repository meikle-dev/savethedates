      ...
      <main id="main">
        <section className="marketing-hero marketing-width" aria-labelledby="hero-title">
          <div className="hero-copy"><p className="marketing-kicker">A little link. A lovely beginning.</p>
            ...
            <p className="hero-description">Your digital save the date, wedding invitation, details and online RSVP, all in one link. Share it by WhatsApp, text or email.</p>
        ...
        <section id="themes" className="theme-showcase" aria-labelledby="themes-title"><div className="marketing-width">
          <div className="section-intro"><p className="marketing-kicker">TWELVE STYLES. ALL YOU.</p><h2 id="themes-title">Find your kind of beautiful.</h2><p>Twelve save the date designs, each with a matching Invitation, Details and RSVP. Same thoughtful features, different ways to tell your story.</p></div>
        ...
        <section id="how-it-works" className="marketing-width marketing-how" aria-labelledby="how-title"><div className="section-intro"><p className="marketing-kicker">FROM YES TO YOU’RE INVITED</p><h2 id="how-title">How your save the date comes together.</h2></div>
          <ol className="marketing-steps"><li><span>01</span><h3>Make it yours</h3><p>Choose a theme, add your names, date and a favourite photo. Preview your site as you go.</p></li><li><span>02</span><h3>Fill in the day</h3><p>Word your invitation, then add ceremony details, travel tips and answers to the questions your guests will ask. Use only the pages you need.</p></li><li><span>03</span><h3>Share the excitement</h3><p>Pay once to publish, then send one private link by WhatsApp, text or email. It opens your Save the Date, and your Invitation, Details and RSVP when you switch them on.</p></li></ol>
        ...
        <section className="marketing-faq" aria-labelledby="faq-title"><div className="marketing-width faq-layout"><div><p className="marketing-kicker">THE LITTLE DETAILS</p><h2 id="faq-title">Save the date questions, answered.</h2></div><div>
          <details><summary>What is a digital save the date?</summary><p>A save the date you send as a link instead of a card. Yours opens with your names, date and photo, and guests can go straight on to your invitation, wedding details and RSVP. <Link className="faq-link" href={digitalSaveTheDatePath}>More about digital save the dates</Link></p></details>
          ...
          <details><summary>Can we still send printed invitations?</summary><p>Yes. Every page apart from your Save the Date is optional. If you’re posting printed invitations, leave the Invitation page off and use your link for the Save the Date, Details and RSVP. Or switch the Invitation on when you’re ready to invite everyone digitally.</p></details>
          ...
          <details><summary>Can we make changes after publishing?</summary><p>Yes. Update your invitation, details, photo or theme and saved changes appear on your published site. You can unpublish at any time. Your guest link stays the same unless you choose to replace it.</p></details>
