      ...
      <main id="main">
        <section className="marketing-hero marketing-width" aria-labelledby="hero-title">
          <div className="hero-copy"><p className="marketing-kicker">A little link. A lovely beginning.</p>
            ...
            <div className="hero-features"><span>Eight beautiful themes</span><span>One simple payment</span><span>Made for mobile</span></div>
          </div>
        ...
        <section id="themes" className="theme-showcase" aria-labelledby="themes-title"><div className="marketing-width">
          <div className="section-intro"><p className="marketing-kicker">EIGHT STYLES. ALL YOU.</p><h2 id="themes-title">Find your kind of beautiful.</h2><p>Same thoughtful features. Eight different ways to tell your story.</p></div>
        ...
        <section id="how-it-works" className="marketing-width marketing-how" aria-labelledby="how-title"><div className="section-intro"><p className="marketing-kicker">FROM YES TO YOU’RE INVITED</p><h2 id="how-title">A few details. A lovely hello.</h2></div>
          ...
          <div id="pricing" className="marketing-pricing"><div><p className="marketing-kicker">ONE WEDDING. ONE SIMPLE PRICE.</p><h2>Everything for your day.</h2><p className="price">£29 <span>GBP · one time</span></p><p>No subscription. Draft and preview for free.</p></div><ul><li>All eight themes, with a photo of your choice</li><li>Your own wedding URL and Details page</li><li>One private RSVP link for all guests</li><li>A private response list and attendance totals</li><li>Published until six months after your wedding date*</li></ul><div className="pricing-action"><AccountAction href={accountHref} label={primaryAccountLabel} /><p>Make something worth sharing.</p></div><p className="pricing-footnote">*Based on the wedding date at checkout. Your expiry date is fixed when you start checkout.</p></div>
        </section>
        <section className="marketing-faq" aria-labelledby="faq-title"><div className="marketing-width faq-layout"><div><p className="marketing-kicker">THE LITTLE DETAILS</p><h2 id="faq-title">Good to know.</h2></div><div>
          <details><summary>Can we try it before paying?</summary><p>Yes. Create an account, save your details and preview all eight themes for free. The one-off £29 payment is required before you publish.</p></details>
          <details><summary>How do guests RSVP?</summary><p>Share one private RSVP link with all guests. Each guest enters their name and answer, without creating an account. Only you can see the responses.</p></details>
