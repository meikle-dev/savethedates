    ...
    <div className="marketing-dark">
      ...
      <main id="main">
        ...
        <section id="how-it-works" className="marketing-width marketing-how" aria-labelledby="how-title"><div className="section-intro"><p className="marketing-kicker">FROM YES TO YOU’RE INVITED</p><h2 id="how-title">A few details. A lovely hello.</h2></div>
          ...
          <div id="pricing" className="marketing-pricing"><div><p className="marketing-kicker">ONE WEDDING. ONE SIMPLE PRICE.</p><h2>Everything for your day.</h2><p className="price">£29 <span>GBP · one time</span></p><p>No subscription. Draft and preview for free.</p></div><ul><li>All three themes, with a photo of your choice</li><li>Your own wedding URL and Details page</li><li>Up to 100 private RSVP invitations</li><li>A private response list and attendance totals</li><li>Published until 12 months after your wedding date*</li></ul><div className="pricing-action"><AccountAction href={accountHref} label={primaryAccountLabel} /><p>Make something worth sharing.</p></div><p className="pricing-footnote">*Based on the wedding date at checkout. Your expiry date is fixed when you start checkout.</p></div>
        </section>
