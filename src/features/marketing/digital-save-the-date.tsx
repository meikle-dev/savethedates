      ...
      <main id="main">
        <section className="marketing-hero marketing-width" aria-labelledby="hero-title">
          <div className="hero-copy"><p className="marketing-kicker">Digital save the dates</p>
            ...
            <p className="hero-description">Send one link by WhatsApp, text or email. Guests open your names, date and photo, then your invitation, wedding details and an RSVP they can answer without an account.</p>
          ...
          <div className="hero-art"><div className="hero-orbit" /><div className="hero-phone-back"><PhonePreview theme="evening-gold" eager sizes="(max-width: 760px) 156px, 208px" /></div><div className="hero-phone-front"><PhonePreview theme="romantic" eager sizes="(max-width: 760px) 175px, 232px" /></div><p className="hero-art-caption">One link.<br /><em>Four lovely pages.</em></p></div>
        </section>
        <section className="marketing-width marketing-how" aria-labelledby="pages-title"><div className="section-intro"><p className="marketing-kicker">ONE LINK. UP TO FOUR PAGES.</p><h2 id="pages-title">Everything guests need, from one message.</h2></div>
          <ol className="marketing-steps marketing-steps-four"><li><span>01</span><h3>Save the Date</h3><p>Your names, date, location and photo, in one of twelve designs made for phones.</p></li><li><span>02</span><h3>Invitation</h3><p>A formal invitation in the same design, with your own wording, the time and the venue. Leave it off if you’re posting printed invitations.</p></li><li><span>03</span><h3>Details</h3><p>Ceremony and reception, timings, travel, where to stay, dress code and answers to guests’ questions. Add only what you need.</p></li><li><span>04</span><h3>RSVP</h3><p>Guests reply with their name and answer, with no account or app. You see every response and the totals in your account.</p></li></ol>
