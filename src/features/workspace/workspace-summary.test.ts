...
describe("workspace summary", () => {
  ...
  it("combines shared and answered legacy responses, newest first", () => {
    const responses = collectResponses(
      [{ id: "s1", responding_name: "Sam", attending: true, responded_at: "2026-09-20T10:00:00Z" }],
      [
        { id: "l1", invite_name: "The Lees", responding_name: "Jordan Lee", attending: false, responded_at: "2026-09-21T10:00:00Z", revoked_at: null },
        { id: "l2", invite_name: "Awaiting", responding_name: null, attending: null, responded_at: null, revoked_at: null },
      ],
    );
