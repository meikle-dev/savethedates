...
const caslon = localFont({ src: [{ path: "../../../public/fonts/libre-caslon-display-latin-400-normal.woff2", weight: "400" }], variable: "--font-caslon", display: "swap", preload: false, fallback: ["Georgia"] });
...
const gloock = localFont({ src: [{ path: "../../../public/fonts/gloock-latin-400-normal.woff2", weight: "400" }], variable: "--font-gloock", display: "swap", preload: false, fallback: ["Georgia"] });
