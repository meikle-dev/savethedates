...
export function PurchasePanel({ entitlement, checkout }: { entitlement: Entitlement; checkout?: string }) {
  ...
  return <div className="mt-6 rounded-2xl border border-[var(--line)] bg-white/45 p-5 sm:p-6">
    ...
    <p className="mt-3 text-sm leading-relaxed text-[var(--muted)]">Includes all twelve themes, one photo, Wedding Details and RSVP. A new purchase keeps your site online until six months after the wedding date. The expiry date is fixed when you start checkout.</p>
