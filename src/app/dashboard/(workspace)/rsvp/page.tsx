...
export default async function Rsvp() {
  ...
  return <WorkspacePage id="rsvp-title" eyebrow="RSVP" title="RSVP" intro="Manage your guest link and RSVP settings. See named responses in Guests.">
    <RsvpManager enabled={wedding.rsvp_enabled} closesOn={wedding.rsvp_closes_on} guestUrl={currentGuestUrl(wedding)} live={live} status={rsvpReadiness(wedding, live, offline)} meals={{ enabled: wedding.meal_choices_enabled, menu: parseMealMenu(wedding.meal_menu) }} />
  </WorkspacePage>;
}
